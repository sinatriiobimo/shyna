<template>
  <div class="product">
    ...
    <RelatedShyna></RelatedShyna>
    <FooterShyna></FooterShyna>
  </div>
</template>

<script>
// @ is an alias to /src
import HeaderShyna from "../components/HeaderShyna";
import RelatedShyna from "../components/RelatedShyna";
import FooterShyna from "../components/FooterShyna";
